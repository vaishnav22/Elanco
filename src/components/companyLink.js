    ...
    const data = [
        {
            ...
            ATOPICA:
            1.Is the first medication specifically approved for the control of chronic atopic dermatitis in dogs weighing at least 4 lbs. (1.8 kg).
            Effectively relieves itchiness and reduces skin lesions.
            2. Provides proven long-term relief.
        ...
        },
        {
            ...
            Bronchi-Shield ORAL was the first modified-live avirulent Bordetella bronchiseptica vaccine licensed for oral administration. Additionally, it’s easy to administer for mucosal delivery and has been proven effective in a published, peer-reviewed challenge study.1`
        },
        {
        ...
        },
        {
            ...
            data:`Powerful, yet easy on your dog. Credelio’s active ingredient, lotilaner, is a member of the isoxazoline family, a novel class of parasiticides that in an in vitro study, showed strong activity on the receptors of ticks and fleas, and no activity on the receptors of dogs.4`
        },
        {
                ...
                <div className="accordion">
                    {data.map((item, i) => (
                        <div className="item">
                            ...
                            <div className={selected ===i ? 'content show' : 'content'}><h3 className="company_data">{item.data}</h3></div>
                        </div>
                    ))}
                </div>
            </div>
